...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //5th{ //for this, also create a custom layout of spinner item
        ...
        //7th{ //for this, we have already created a custom layout of spinner item
...
//                    Toast.makeText(MainActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW,   Uri.parse("https://play.google.com/store/apps/details?id=com.google.android.apps.googleassistant&hl=en_IN&gl=US"));
